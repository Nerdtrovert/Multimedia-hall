...
| File Storage | Database-backed BLOB storage with legacy filesystem fallback |
...
│   │   ├── bookingController.js   # Submit, approve/reject, file access
...
│   │   ├── pushNotifications.js   # Firebase FCM push notifications
│   │   ├── audit.js               # DB audit log writer
│   ├── services/
│   │   └── reportReminderScheduler.js # Daily cron job for report reminders
│   ├── logs/actions.log           # File-based action log
│   ├── uploads/                   # Legacy fallback for old file-path records
...
bookings
  ...
  poster_data, poster_file_path, poster_original_name, poster_mime_type, poster_uploaded_at,
  event_date, start_time, end_time,
  event_report_data, event_report_file_path, event_report_original_name, event_report_mime_type, event_report_uploaded_at,
...
MAIL_FROM=Auditorium System <your_email@gmail.com>
